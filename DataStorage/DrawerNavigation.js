...
const navigator = createDrawerNavigator({
    AsyncStorage:{screen:stackPage1,navigationOptions: {
    header:null}},
    SQL1:{screen:stackPage2,navigationOptions: {
    header:null}},
    SQL2:{screen:stackPage3,navigationOptions: {
    header:null}},
    Task:{screen:stackPage4,navigationOptions: {
    header:null}},
  })
